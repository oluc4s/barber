...
val PaleWhite = Color(0xFFF5F7F9)
val SlatePurple = Color(0xFF3F3D56)
val SlateBlue = Color(0xFF8D9CB8)

val MutedAzure = Color(0xFFC6CFDC)
val Blue = Color(0xFF007FFF)
val BlueContent = Color(0x1A007FFF)
val CardPro = Color(0xFFE9B35E)
